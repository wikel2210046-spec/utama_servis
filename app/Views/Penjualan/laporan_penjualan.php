    ...
    <div class="d-flex justify-content-between align-items-end mb-2">
        <div>
            ...
            if (!empty($pelanggan_terpilih)) {
                $namaPelangganTerpilih = '';
                foreach ($pelanggan as $p) {
                    if ($p['id_pelanggan'] == $pelanggan_terpilih) {
                        $namaPelangganTerpilih = $p['nama_pelanggan'];
                        break;
                    }
                }
                $filterTeks[] = "Pelanggan: " . esc($namaPelangganTerpilih);
            } else {
                $filterTeks[] = "Pelanggan: Semua";
            }
    ...
    <form action="<?= base_url('Penjualansparepart/filterPenjualan') ?>" method="get" class="filter-bar bg-light p-3 rounded shadow-sm mb-4">
        <div class="row align-items-end g-2">
            ...
            <div class="col-md-2 col-sm-4 mb-2 mb-md-0">
                ...
                <select name="pelanggan" class="form-control form-control-sm">
            ...
            <div class="col-md-2 col-sm-4 d-flex justify-content-end align-items-center mb-2 mb-md-0" style="gap: 4px;">
                ...
                <a href="<?= base_url('Penjualansparepart/laporan') ?>" class="btn btn-secondary btn-sm shadow-sm" title="Reset Filter"><i class="fa-solid fa-arrows-rotate"></i></a>
            </div>
        </div>
    </form>
