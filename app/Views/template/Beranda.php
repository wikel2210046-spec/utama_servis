                        ...
                        <div class="container">
                            <div class="row align-items-center justify-content-center justify-content-lg-start">
                                <div class="col-10 col-lg-7 text-center text-lg-start">
                                    <h6 class="text-white text-uppercase mb-3 animated slideInDown">// Servis Mobil //
                                    </h6>
                                    <h1 class="display-3 text-white mb-4 pb-3 animated slideInDown">Pusat Layanan
                    ...
                    <div class="col-lg-6 mb-5 mb-lg-0">
                        <div class="wow fadeInLeft" data-wow-delay="0.2s">
                            ...
                            <h1 class="mb-4 fw-bold text-dark">
                                Servis Mobil Mudah & Cepat Bersama <span class="text-primary">Utama Service
                                    Station</span>
                            </h1>
                            ...
                            <ul class="list-unstyled text-secondary">
                                <li class="mb-2"><i class="fa fa-check-circle text-primary me-2"></i>Teknisi Profesional
                                    & Bersertifikat</li>
                                <li class="mb-2"><i class="fa fa-check-circle text-primary me-2"></i>Peralatan Modern &
                                    Lengkap</li>
                                ...
                                <form id="formBooking">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <select class="form-select border-secondary" id="id_mobil" name="id_mobil"
                                                required>
                                                ...
                                                <small class="text-muted">Belum ada mobil?
                                                    <?php if (session()->get('loggedin')): ?>
                                                        <a href="<?= site_url('/Mobil') ?>"
                                                            class="text-primary fw-bold">Tambah Mobil Anda</a>
                                                    <?php else: ?>
                                        ...
                                        <div class="col-12 col-sm-6">
                                            ...
                                            <input type="date" class="form-control border-secondary" id="tanggal_servis"
                                                name="tanggal_servis" min="<?= date('Y-m-d') ?>" required>
                                        </div>

                                        <!-- Jam Servis -->
                                        <div class="col-12 col-sm-6">
                                            <label class="form-label fw-semibold">Jam Servis</label>
                                            <select class="form-select border-secondary" id="jam_servis"
                                                name="jam_servis" required>
                                                <option value=""></option>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <textarea class="form-control border-secondary" name="keluhan"
                                                placeholder="Tulis keluhan atau permintaan servis Anda..."
                                                rows="3"></textarea>
                                        </div>
